...
The manuscript introduces \emph{Evidence-Complete Transition Closure} (ECTC), a protocol semantics in which a state transition is not terminal merely because a validator accepted it. A Capsule must reach a \emph{Closed} outcome carrying a ClosureProof and successor StateSeal, a \emph{Conflict} outcome carrying a recorded, auditable ConflictEvidence artifact, or an \emph{Abandoned} outcome carrying an AbandonProof. The proposed lifecycle binds predecessor state, transition claim, witness obligation, and successor state while preserving incompatible and abandoned claims as recorded, auditable artifacts.
