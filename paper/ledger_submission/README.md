...
The submission bundle uses a neutral page style without journal-assigned volume, page-range, DOI, or under-consideration placeholders. Those publication fields are intentionally omitted until the journal assigns them after acceptance. The current repository revision collects 102 automated tests; all evaluation rows are explicitly marked as LOCAL_EMULATION or in-process serialized measurements.
